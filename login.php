                ...
                <div class="col-md-6 p-4">
                    ...
                    <form id="loginform" method="post" action="">
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="remember" name="remember" value="1" <?php if($remember == 1) echo'Checked' ?>>
                            <label class="form-check-label" for="remember">Remember me</label>
                        </div>
                        <button type="submit" name="login" value="login" class="btn btn-success mb-3">Login</button>
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="/home"><button type="button" class="btn btn-dark">Home</button></a>
                            <div class="d-flex align-items-center">
                                <span class="fs-6 mx-2">New here?</span>
                                <a id="regbtn" href="/register">
